    ...
    public partial class frmClient : Form
    {
        ...
        private void pbab_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connection.ConnectionString = @"Server=localhost; DATABASE=crossfit; UID=root; PASSWORD=; allow User Variables=True";
                connection.Open();
            ...
            for(int i = 0; i < nrab; i++)
            {
                ...
                {
                    pb.ImageLocation = AppDomain.CurrentDomain.BaseDirectory + "/Poze/grup.jpg";
                }
                else
                {
                    pb.ImageLocation = AppDomain.CurrentDomain.BaseDirectory + "/Poze/p1.jpg";
                }
                ...
                btn.Click += btn_Click;
                btn.Tag = i;
                //btn.BackgroundImage = Image.FromFile("D:\\Informatica\\Atestat\\Gestiune sala crossfit\\Gestiune sala crossfit\\bin\\Debug\\Poze\\rez.jpg");
            ...
            if (adauga)
            {
                try
                {
                    ...
                    if (cmd.ExecuteNonQuery() != 0)
                    {
                        ...
                        mail.From = new MailAddress("irongymcrossfit@gmail.com");
                        ...
                        server.Credentials = new NetworkCredential("irongymcrossfit@gmail.com", "~;Wy6_g94nVZLjX");
